...
def _body_flowables(msg) -> list:
    ...
    # Placeholders may appear mid-line (inline image inside a paragraph),
    # so split every line on the pattern rather than only matching whole lines.
    flowables = []
